...
public class LionTest extends TestCase {
    ...
    @Test
    public void testGetKittensM() throws Exception {
    ...
    @Test
    public void testGetKittensF() throws Exception {
    ...
    @Test
    public void testDoesHaveManeF() throws Exception {
        lion = new Lion(FEMALE, feline);
        assertFalse(lion.doesHaveMane());
    }
    @Test
    public void testDoesHaveManeM() throws Exception {
        lion = new Lion(MALE, feline);
